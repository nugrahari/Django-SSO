...
SECRET_KEY = 'django-insecure-nn9l)@gfs#%1n#s)f($gw(dth(lj@@8x!#=6)!n4jrj87ueci%'
...
SIMPLE_JWT = {
    'SIGNING_KEY': JWT_PRIVATE_KEY,  # Set to the secret key of the service
...
STATIC_URL = 'static/'
# Tempat mengumpulkan file statis
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Folder tambahan untuk file statis
]
